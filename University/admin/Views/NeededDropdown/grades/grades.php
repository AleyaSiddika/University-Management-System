                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Add Grade
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="row tableDs">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <label for="code" class="col-sm-12 title">Add Grade</label>
                            </div><br>
                            <form method="post" action="storeGrade.php" name="grades">
                                <div class="form-group row">
                                    <label for="grade" class="col-sm-4 col-form-label txt">Grade Letter</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="grade" class="form-control" id="grade" placeholder="Grade Letter">
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="col-sm-12">
                            ...
                            <input type="submit" value="Show Grade" class="btn btn-success"  id="btn"><br><br>
                        </div>
                    </div>
                </div> <br><br>
...
<div id="box1" style="display: none;">
                <div class="container mainTable" id="BoxOut" >
                    <div class="row tabled">
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label for="code" class="col-sm-12 title">Show All Grade</label>
                            </div>
                            <div class="col-md-12">
                                <table class="table table-striped tabled">
                                    ...
                                    <tr>
                                        ...
                                        <th class="txtd">Grades Name</th>
                                        <th class="txtd" style="width: 90px;">Action</th>
                                    </tr>
                                    </thead>
                                    <?php
                                    foreach ($allGrade as $data)
                                    {
                                    ?>
                                    <tbody>
                                    <tr>
                                        <td class="datad"><?php echo $data['id']; ?></td>
                                        <td class="datad"><?php echo $data['grade']; ?></td>
                                        <td class="datad">
    ...
    <script src="../../../js/validation/form_validation_grades.js"></script>
