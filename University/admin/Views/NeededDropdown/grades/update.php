            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="grades.php"> Add Grade </a> || Update Grade
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row tableDs">
                    <div class="col-md-12">
                        ...
                        <form method="post" action="edit.php">
                            <div class="form-group row">
                                <label for="grade" class="col-sm-4 col-form-label txt">Grade Name</label>
                                <div class="col-sm-8">
                                    <input type="text" name="grade" class="form-control"value="<?php  echo $grd['grade'];  ?>"placeholder="Grade Letter">
                                    <input type="hidden" name="id" value="<?php echo $grd['id']; ?>">
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col-sm-12">
