                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Add Semesters
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="row tableDs">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <label for="code" class="col-sm-12 title">Add Semesters</label>
                            </div><br>
                            <form method="post" action="storeSeme.php" name="semester">
                                <div class="form-group row">
                                    <label for="seme" class="col-sm-4 col-form-label txt">Seme Name</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="seme" class="form-control" id="seme" placeholder="Name">
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="col-sm-12">
                            ...
                            <input type="submit" value="Show Semester" class="btn btn-success"  id="btn"><br><br>
                        </div>
                    </div>
                </div> <br><br>
...
<div id="box1" style="display: none;">
                <div class="container mainTable" id="BoxOut" >
                    <div class="row tabled">
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label for="code" class="col-sm-12 title">Show All Semesters</label>
                            </div>
                            <div class="col-md-12">
                                <table class="table table-striped tabled">
                                    ...
                                    <tr>
                                        ...
                                        <td class="datad"><?php echo $data['semester']; ?></td>
                                        <td class="datad">
    ...
    <script src="../../../js/validation/form_validation_seme.js"></script>
