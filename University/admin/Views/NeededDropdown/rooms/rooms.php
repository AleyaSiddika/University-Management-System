                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Add Rooms No.
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="row tableDs">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <label for="code" class="col-sm-12 title">Add Rooms No.</label>
                            </div><br>
                            <form method="post" action="storeRooms.php" name="rooms">
                                <div class="form-group row">
                                    <label for="room" class="col-sm-4 col-form-label txt">Rooms No.</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="room"  class="form-control" id="room" placeholder="Name">
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="col-sm-12">
                            ...
                            <input type="submit" value="Show Room No" class="btn btn-success"  id="btn"><br><br>
                        </div>
                    </div>
                </div> <br><br>
...
<div id="box1" style="display: none;">
                <div class="container mainTable" id="BoxOut" >
                    <div class="row tabled">
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label for="code" class="col-sm-12 title">Show All Rooms No.</label>
                            </div>
                            <div class="col-md-12">
                                <table class="table table-striped tabled">
                                    ...
                                    <tr>
                                        ...
                                        <td class="datad"><?php echo $data['rooms']; ?></td>
                                        <td class="datad">
    ...
    <script src="../../../js/validation/form_validation_rooms.js"></script>
