            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="rooms.php">Add Rooms No.</a> || Update Rooms No.
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="edit.php">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="room" class="form-control" value="<?php  echo $room['rooms'];  ?>">
