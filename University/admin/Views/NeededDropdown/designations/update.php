            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="designations.php"> Add Designation </a> || Update Designations
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row tableDs">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="code" class="col-sm-12 title">Update Designations</label>
                        </div><br>
                        <form method="post" action="edit.php">
                            <div class="form-group row">
                                <label for="des" class="col-sm-4 col-form-label txt">Des. Name</label>
                                <div class="col-sm-8">
                                    <input type="text" name="des" class="form-control" value="<?php  echo $des['designation'];  ?>" >
