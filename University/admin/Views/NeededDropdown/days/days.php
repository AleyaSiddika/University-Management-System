...
<body>
                    ...
                    <div class="row tableDs">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <label for="code" class="col-sm-12 title">Add Days</label>
                            </div><br>
                            <form method="post" action="storeDays.php"  name="save_day">
                                <div class="form-group row">
                                    <label for="day" class="col-sm-4 col-form-label txt">Day Name</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="day" class="form-control" id="day" placeholder="Day Name">
                                    </div>
                                </div><br>
                                <div class="row">
                                    <div class="col-sm-12">
                            ...
                            <input type="submit" value="Show Days" class="btn btn-success"  id="btn"><br><br>
                        </div>
                    </div>
                </div> <br><br>
                ...
                <div id="box1" style="display: none;">
                    <div class="container mainTable" id="BoxOut" >
                        <div class="row tabled">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label for="code" class="col-sm-12 title">Show All Days</label>
                                </div>
                                <div class="col-md-12">
                                    <table class="table table-striped tabled">
                                        ...
                                        <tr>
                                            ...
                                            <td class="datad"><?php echo $data['day']; ?></td>
                                            <td class="datad">
    ...
    <script src="../../../js/validation/form_validation_day.js"></script>
