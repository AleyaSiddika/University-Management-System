    ...
    <nav class="navbar navbar-inverse navbar-fixed-top header" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Needed Dropdown <i class="fa fa-fw fa-caret-down"></i></a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="days.php"> Add Days </a> || Update days
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row tableDs">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="code" class="col-sm-12 title">Update Days</label>
                        </div><br>
                        <form method="post" action="edit.php">
                            <div class="form-group row">
                                <label for="day" class="col-sm-4 col-form-label txt">Day Name</label>
                                <div class="col-sm-8">
                                    <input type="text" name="day" value="<?php  echo $day['day'];  ?>" class="form-control" id="" placeholder="Day Name">
