    ...
    <nav class="navbar navbar-inverse navbar-fixed-top header" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="ViewCourseStatic.php"><i class="fa fa-fw fa-table"></i> Course Statics </a>
                </li>
                <li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> View Courses Static
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row mainBody">
                    <div class="col-md-12">
                        <table class="table table-striped">
                            <p class="titleD">View Course Static</p>
                            <div class="form-group row DptTitle">
                                <label for="dept" class="col-sm-4 col-form-label DeptNAme">Department</label>
                                <div class="col-sm-8">
                                    <select class="form-control" name="dept" id="stdReg">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="courseInfo"> Course Information</p>
                                    </div>
                                </div>
                                <tr>
                                    <th class="txt" style="width: 200px;">Course Code</th>
                                    <th class="txt">Course Name</th>
                                    <th class="txt" style="width: 100px;">Semester</th>
                                    <th class="txt" style="width: 250px;">Assigned To</th>
                                </tr>
                                </thead>
            ...
            $.ajax({
                ...
                success:function(response) {
                    ...
                    for( var i = 0; i<len; i++){
                        ...
                        var name = response['course'][i]['crs_name'];
                        var semester = response['seme'][i]['semester'];
                        var tea = response['course'][i]['t_name'];

                        $("#opt").append("<tr>");
                        $("#opt").append("<td class='style'>"+code+"</td>");
                        $("#opt").append("<td  class='style'>"+name+"</td>");
                        $("#opt").append("<td  class='style'>"+semester+"</td>");
                        $("#opt").append("<td  class='style'>"+tea+"</td>");
                        $("#opt").append("</tr>");
                    }
