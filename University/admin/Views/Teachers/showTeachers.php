            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="addTeachers.php">Add Teachers</a> || View Teachers  || <a href="UndoShowTeachers.php">Deleted Data</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row mainBody">
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <thead>
                            <tr>
                                <th class="txt" style="width: 160px;">Name</th>
                                <th class="txt" >Address</th>
                                <th class="txt"  style="width: 150px;">Email</th>
                                <th class="txt" style="width: 110px;">Contact No.</th>
                                <th class="txt" style="width: 90px;">Designation</th>
                                <th class="txt"  style="width: 90px;">Department</th>
                                <th class="txt" style="width: 60px;">CTBT</th>
                                <th class="txt" style="width: 50px;">Edit</th>
                            ...
                            foreach ($allTea as $data)
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="data"><?php echo $data['contact']; ?></td>
                                    <td class="data"><?php echo $data['designation']; ?></td>
                                    <td class="data"><?php echo $data['name']; ?></td>
                                    <td class="data"><?php echo $data['credittaken']; ?></td>
                                    <td class="data">
