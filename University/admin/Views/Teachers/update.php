...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="showTeachers.php">Back to View Teachers</a> || Update Teachers
                        </li>
                    </ol>
                </div>
            </div>
            ...
            $obj4 = new \App\Designation\Designation();
            $des = $obj4->getAllData();
            ?>
                ...
                <div class="row table">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="code" class="col-sm-12 title">Update Teachers</label>
                        </div>
                        <form method="post" action="edit.php">
                            <div class="form-group row">
                                <label for="code" class="col-sm-5 col-form-label txt">Name</label>
                                <div class="col-sm-7">
                                    <input type="text" name="name"  value="<?php  echo $edit['t_name'];  ?>" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <textarea class="form-control" name="address" id="exampleTextarea" rows="3"><?php echo $edit['address']; ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="cont" value="<?php  echo $edit['contact'];  ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control"  name="des" id="exampleSelect1">
                                            <option><?php echo $edit['designation'] ?></option>
                                            <?php
                                            foreach ($des as $d)
                                            {
                                                ?>
                                                <option>  <?php  echo $d['designation'];  ?></option>
                                            <?php }?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="credittaken" value="<?php  echo $edit['credittaken'];  ?>" class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
