            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    ...
                    <ul id="demo" class="collapse">
                        <li>
                            <a href="department.php">Add Departments</a>
                        </li>
                        <li>
                            <a href="showDept.php">Show Departments</a>
                        </li>
                    </ul>
                </li>
                <li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="department.php">Add Departments</a> || View All Departments || <a href="showAllUndoDept.php">Deleted Data</a>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <th class="txt" style="width: 120px;">Code</th>
                                <th class="txt">Departments Name</th>
                                <th class="txt" style="width: 110px;">Edit</th>
                                <th class="txt" style="width: 0px;">
