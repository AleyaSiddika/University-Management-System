                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> <a href="showDept.php">View All Departments</a> || Add Departments
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="row table">
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label for="code" class="col-sm-12 title">Add Department</label>
                            </div><br>
                            <form method="post" action="depStore.php" name="save_department">
                                <div class="form-group row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input type="submit" value="Save" name="save" class="btn btn-primary saveBtn"  id="">
                                    </div>
                                </div><br>
                            </form>
                            <div class="msg">
