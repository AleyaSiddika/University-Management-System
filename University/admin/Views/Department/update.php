            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="showDept.php">Back to View Departments</a> || Update Departments
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="edit.php">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="code" class="form-control" value="<?php  echo $depart['code'];  ?>">
                                </div>
                            </div>
                            <div class="form-group row">
