            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i><a href="showCourse.php"> View All Course</a> || Add Course
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row table">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <label for="code" class="col-sm-12 title">Add Course</label>
                        </div>
                        <form method="post" action="courseStore.php" name="add_course">
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="description" class="col-sm-4 col-form-label txt">Description</label>
                                <div class="col-sm-8">
...
<script src="../../js/validation/form_validation_course.js"></script>
