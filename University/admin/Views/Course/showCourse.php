            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="course.php">Add Courses</a> || VIew All Courses || <a href="UndoshowCourse.php">Deleted Data</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row mainBody">
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <thead>
                            <tr>
                                <th class="txt" style="width: 130px;">Course Code</th>
                                <th class="txt">Course Name</th>
                                <th class="txt" style="width: 70px;">Credit</th>
                                <th class="txt">Description</th>
                                <th class="txt" style="width: 100px;">Department</th>
                                <th class="txt" style="width: 90px;">Semester</th>
                            ...
                            foreach ($allCourse as $data)
                            {
                                ...
                                <tr>
                                    ...
                                    <td class="data"><?php echo $data['description']; ?></td>
                                    <td class="data"><?php echo $data['name']; ?></td>
                                    <td class="data"><?php echo $data['semester']; ?></td>
                                    <td class="data">
