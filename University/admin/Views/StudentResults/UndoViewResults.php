...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="StudentResults.php">Add Student Results</a> ||  <a href="ViewResults.php"> View Student Results</a> || View Deleted Student Results
                        </li>
                    </ol>
                </div>
            </div>
            ...
            $allStdRes = $data->getAllDeleteData();
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-striped">
                            ...
                            foreach ($allStdRes as $data)
                            {
                                ...
                                <tbody>
                                <tr>
                                    <td class="data"><?php echo $data['std_reg']; ?></td>
