            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="ViewResults.php">View Results</a> || Add Student Results
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="storeResults.php">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control" name="course" id="courseCD">
...
//                  console.log(response['courses']);
                    ...
                    for( var i = 0; i<crid; i++){
                        ...
                        var code = response['courses'][i]['course'];
                        $("#courseCD").append("<option value='"+code+"'>"+code+"</option>");
