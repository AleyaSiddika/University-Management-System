...
<div id="wrapper">
            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    ...
                    <ul id="demo9" class="collapse">
                        <li>
                            <a href="StudentResults.php">Add Student Result</a>
                        </li>
                        <li>
                            <a href="ViewResults.php">Show Student Result</a>
                        </li>
                    </ul>
                </li>
            </ul>
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="ViewResults.php">Back to View Results</a> || Update Student Results
                        </li>
                    </ol>
                </div>
            </div>
            ...
            $obj2 = new \App\RegisterStudents\RegisterStudents();
            $allReg = $obj2->getAllData();

            $obj3 = new \App\Course\Course();
            $allCr = $obj3->getAllData();

            $obj4 = new \App\Grade\Grade();
            $allGr = $obj4->getAllData();
                ...
                <div class="row table">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="code" class="col-sm-12 title">Update Student Results</label>
                        </div>
                        <form method="post" action="edit.php">
                            <div class="form-group row">
                                <label for="reg" class="col-sm-5 col-form-label txt">Student Reg. No.</label>
                                <input type="hidden" name="id" value="<?php echo $edit['id']; ?>">
                                <div class="col-sm-7">
                                    <select class="form-control" name="stdRegs" id="exampleSelect1">
                                        <option value="<?php echo $edit['std_reg']; ?>"> <?php  echo $edit['regnum'];  ?></option>
                                        <?php
                                        foreach ($allReg as $reg){
                                            ?>
                                            <option value="<?php echo $reg['id']; ?>"><?php echo $reg['regnum']; ?></option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="dept" class="form-control" value="<?php  echo $edit['department'];  ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="credit" class="col-sm-5 col-form-label txt">Select Course</label>
                                <div class="col-sm-7">
                                    <select class="form-control" name="course" id="exampleSelect1">
                                            <option> <?php  echo $edit['course'];  ?></option>
                                        <?php
                                        foreach ($allCr as $cr){
                                            ?>
                                            <option><?php echo $cr['c_name']; ?></option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="credit" class="col-sm-5 col-form-label txt">Select Grade Letter</label>
                                <div class="col-sm-7">
                                    <select class="form-control" name="grade" id="exampleSelect1">
                                            <option> <?php  echo $edit['grade_letter'];  ?></option>
                                        <?php
                                        foreach ($allGr as $gr){
                                            ?>
                                            <option><?php echo $gr['grade']; ?></option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
