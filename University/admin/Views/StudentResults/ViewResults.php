...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="StudentResults.php">Add Student Results</a> || View Student Result ||  <a href="UndoViewResults.php">Deleted Data</a>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            $data = new StudentResults();
            $allStdRes = $data->getData();
                ...
                <div class="row mainBody">
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php
                            foreach ($allStdRes as $data)
                            {
                                ?>
                                <tbody>
                                <tr>
                                    <td class="data"><?php echo $data['regnum']; ?></td>
                                    <td class="data"><?php echo $data['name']; ?></td>
                                    <td class="data"><?php echo $data['email']; ?></td>
                                    <td class="data"><?php echo $data['department']; ?></td>
                                    <td class="data"><?php echo $data['course']; ?></td>
                                    <td class="data"><?php echo $data['grade_letter']; ?></td>
                                    <td class="data">
