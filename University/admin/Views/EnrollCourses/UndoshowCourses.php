            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="EnrollCourses.php">Add Enroll Courses</a> || <a href="showCourses.php">View All Enroll Courses</a> || View All Deleted Enroll Courses
                        </li>
                    </ol>
                </div>
            </div>
