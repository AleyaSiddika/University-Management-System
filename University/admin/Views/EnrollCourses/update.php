...
<head>
    ...
    <title>Enroll Course Udate</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="showCourses.php">Back to View Enroll Courses</a> || Add Enroll Courses
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row table">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="code" class="col-sm-12 title">Update Enroll Course</label>
                        </div>
                        <form method="post" action="edit.php">
                            <div class="form-group row">
                                <label for="stdReg" class="col-sm-5 col-form-label txt">Student Reg. No.</label>
                                <div class="col-sm-7">
                                    <select class="form-control"  name="stdReg" id="exampleSelect1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="date"  value="<?php echo $edit['date']; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
