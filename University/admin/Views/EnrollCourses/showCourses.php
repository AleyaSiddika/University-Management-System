            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="EnrollCourses.php">Add Enroll Courses</a> ||  View All Enroll Courses ||  <a href="UndoshowCourses.php">Deleted Data</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row mainBody">
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <thead>
                            <tr>
                                <th class="txt" style="width: 140px;">Reg No.</th>
                                <th class="txt">Name</th>
                                <th class="txt">Email</th>
                                <th class="txt" style="width: 110px;">Department</th>
                                <th class="txt">Course</th>
                                <th class="txt"  style="width: 100px;">Date</th>
