            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="AddAllocateRooms.php">Add Allocate Classrooms</a> || View Allocate Classrooms || <a href="UndoshowAlloRooms.php">Deleted Data</a>
                        </li>
                    </ol>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <th class="txt" style="width: 120px;">
