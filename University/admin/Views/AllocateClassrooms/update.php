...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="showAlloRooms.php">Back to View Allocate Classrooms</a> || Update Allocate Rooms
                        </li>
                    </ol>
                </div>
            </div>
            ...
            $obj0 = new \App\Course\Course();
            $allCr= $obj0->getAllData();

            $obj = new \App\Days\Days();
            $allDay= $obj->getAllData();

            $obj1 = new \App\Rooms\Rooms();
            $allRm= $obj1->getAllData();
            ?>
                ...
                <div class="row table">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="code" class="col-sm-12 title">Update Allocate Classrooms</label>
                        </div>
                        <form method="post" action="edit.php">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control"  name="course" id="exampleSelect1">
                                            <option value="<?php echo $edit['id']; ?>"> <?php echo $edit['c_name']; ?></option>
                                        <?php
                                        foreach ($allCr as $data) {
                                            ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="room" id="exampleSelect1">
                                            <option name="dept"> <?php echo $edit['room']; ?></option>

                                        <?php
                                        foreach ($allRm as $data) {
                                            ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control"  name="day" id="exampleSelect1">
                                            <option> <?php echo $edit['days']; ?></option>
                                        <?php
                                        foreach ($allDay as $data) {
                                            ?>
                                            <option name="dept"> <?php echo $data['day']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="time" name="form"  value="<?php echo $edit['start_time']; ?>" style="text-align: center;"  class="form-control" >
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="time" name="timeTo" value="<?php echo $edit['end_time']; ?>" style="text-align: center;"  class="form-control" >
                                </div>
