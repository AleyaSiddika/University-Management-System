...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="RegisterStds.php">Add Register Students</a> || <a href="showRegStd.php">View Register Students</a> || View All Deleted Register Students
                        </li>
                    </ol>
                </div>
            </div>
            ...
            $allRegStd = $data->getAllDeleteData();
