            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    ...
                    <ul id="demo5" class="collapse">
                        <li>
                            <a href="RegisterStds.php">Add Register Student</a>
                        </li>
                        <li>
                            <a href="showRegStd.php">Show Register Student</a>
                        </li>
                    </ul>
                </li>
                <li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="showRegStd.php">Back to View Reg. Students</a> || Update Register Students
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row table">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="code" class="col-sm-12 title">Update Register Sutdents</label>
                        </div>
                        <form method="post" action="edit.php">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-sm-4 col-form-label txt">Email</label>
                                <div class="col-sm-8">
                                    <input type="email" name="email" class="form-control"value="<?php  echo $edit['email'];  ?>" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="cont" class="col-sm-4 col-form-label txt">Contact No.</label>
                                <div class="col-sm-8">
                                    <input type="text" name="cont" class="form-control" value="<?php  echo $edit['contact'];  ?>" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="date" class="col-sm-4 col-form-label txt">Date</label>
                                <div class="col-sm-8">
                                    <input type="text" value="<?php  echo $edit['date'];  ?>"  name="date" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="add" class="col-sm-4 col-form-label txt">Address</label>
                                <div class="col-sm-8">
                                    <textarea class="form-control" name="add" id="exampleTextarea" rows="3"><?php  echo $edit['address'];  ?></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="dept" id="exampleSelect1">
                                            <option name="dept"> <?php echo $edit['department']; ?></option>
                                        <?php
                                        foreach ($dept as $d)
                                        {
                                            ?>
