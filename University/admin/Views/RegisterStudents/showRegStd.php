...
<head>
    ...
    <title>View Register Student</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="RegisterStds.php">Add Register Students</a> || View Register Students || <a href="UndoshowRegStd.php">Deleted Data</a>
                        </li>
                    </ol>
                </div>
            </div>
