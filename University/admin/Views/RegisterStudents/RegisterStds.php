            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="showRegStd.php">View Reg. Students</a> || Register Students
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row table">
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <label for="code" class="col-sm-12 title">Register Sutdents</label>
                        </div>
                        <form method="post" action="storeReg.php" name="register_student">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="dept" id="exampleSelect1">
                                        ...
                                        foreach ($allDept as $data) {
                                            ?>
                                            <option name="dept"> <?php echo $data['name']; ?></option>
                                            <?php
                                        }
                                        ?>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <input type="submit" value="Register" class="btn btn-primary saveBtn"  id="">
                                </div>
                            </div><br><br>
                        </form>
...
<script src="../../js/validation/form_validation_reg_std.js"></script>
