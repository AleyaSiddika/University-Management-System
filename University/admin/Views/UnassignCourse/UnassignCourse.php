        ...
        <nav class="navbar navbar-inverse navbar-fixed-top header" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="UnassignCourse.php"><i class="fa fa-fw fa-table"></i> Unassign All Course </a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Unassign All Courses
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="row table">
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label for="code" class="col-sm-12 title">Unassign All Courses</label>
                            </div>
                            <div class="msg">
                                <?php
                                @session_start();
                            ...
                            <form method="post" action="#">
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <div class="bnnt">
                                            <a href="delete.php" class="btn btn-default saveBtn">Unassign Courses</a>
                                        </div>
                                    </div>
                                </div><br><br>
                            </form>
