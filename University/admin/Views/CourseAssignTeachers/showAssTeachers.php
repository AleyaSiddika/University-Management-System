...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="addAssignTeachers.php">Add Assign Teachers</a> || View Assign Teachers ||  <a href="UndoshowAssTeachers.php">Deleted Data</a>
                        </li>
                    </ol>
                </div>
            </div>
            ...
            $data = new CourseAssignTeacher();
            $allAssTea = $data->getData();
            ...
            <div class="container">
                <div class="row mainBody">
                    <div class="col-md-12">
                        <form action="deleteAll.php" method="post"  onsubmit="return confirm('Do you really want to delete data ?');">
                        <table class="table table-bordered ">
                            ...
                            <thead>
                            <tr>
                                <th class="txt" style="width: 100px;">Department</th>
                                <th class="txt">Teachers</th>
                                <th class="txt" style="width: 120px;">Credit taken</th>
                                <th class="txt" style="width: 120px;">Rem. Credit</th>
                                <th class="txt" style="width: 120px;">Course code</th>
                                <th class="txt">Course Name</th>
                                <th class="txt" style="width: 30px;">Credit</th>
                                <th class="txt" style="width: 30px;">Edit</th>
                                <th class="txt" style="width: 100px;">
                                    <button type="submit" name="delete" class="btnnnnn btn-xs">Delete</button> ||
                            ...
                            <?php
                            foreach ($allAssTea as $data)
                            {
                                ?>
                                <tbody>
                                <tr>
                                    <td class="data"><?php echo $data['name']; ?></td>
                                    <td class="data"><?php echo $data['t_name']; ?></td>
                                    <td class="data"><?php echo $data['credit_taken']; ?></td>
                                    <td class="data"><?php echo $data['remain_credit']; ?></td>
                                    <td class="data"><?php echo $data['code']; ?></td>
                                    <td class="data"><?php echo $data['crs_name']; ?></td>
                                    <td class="data"><?php echo $data['credit']; ?></td>
                                    <td class="data">
                                        <a href="update.php?id=<?php echo $data['id']; ?>"><li class="fa fa-edit size"></li></a>
                                    </td>
                                    <td class="data">
