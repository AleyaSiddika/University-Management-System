...
<head>
    ...
    <title>Teachers Assign Update</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="showAssTeachers.php">Back to View Assign Teachers</a> || Update Assign Teachers
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row table">
                    <div class="col-md-12">
                        <div class="form-group row">
                            <label for="code" class="col-sm-12 title">Update Assign To Teachers</label>
                        </div>
                        <form method="post" action="edit.php">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control" required="required" name="teacher" id="exampleSelect1">
                                        <option value="<?php echo $edit['teacher'] ?>"><?php echo  $edit['t_name']; ?> </option>
                                        <?php
                                        foreach ($tea as $t)
                                        {
                                        ?>
                                        <option value="<?php  echo $t['id'];  ?>" >  <?php  echo $t['t_name'];  ?></option>
                                        <?php }?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="ctbt" class="form-control" value="<?php  echo $edit['credit_taken'];  ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Remaining" class="col-sm-5 col-form-label txt">Remaining Credit</label>
                                <div class="col-sm-7">
                                    <input type="text" name="RemCredit" class="form-control" value="<?php  echo $edit['remain_credit'];  ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="credit" class="col-sm-5 col-form-label txt">Course Code</label>
                                <div class="col-sm-7">
                                    <select class="form-control" required="required" name="courseCD" id="exampleSelect1">
                                        <option value="<?php  echo $edit['course_code'];  ?>"><?php  echo $edit['code'];  ?></option>
                                        <?php
                                        foreach ($crs as $cc)
                                        {
                                            ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="name" class="form-control" value="<?php  echo $edit['crs_name'];  ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="credit" class="col-sm-5 col-form-label txt">Credit</label>
                                <div class="col-sm-7">
                                    <input type="text" name="credit" class="form-control" value="<?php  echo $edit['credit'];  ?>">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
