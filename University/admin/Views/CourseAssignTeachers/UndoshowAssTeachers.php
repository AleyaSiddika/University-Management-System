...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-edit"></i> <a href="addAssignTeachers.php">Add Assign Teachers</a> || <a href="showAssTeachers.php"> View Assign Teachers</a> || View All Deleted Assign Teachers
                        </li>
                    </ol>
                </div>
            </div>
            ...
            $allAssTea = $data->getAllDeleteData();
            ...
            <div class="container">
                <div class="row mainBody">
                    <div class="col-md-12">
                        <form action="UndoDelete.php" method="post"  onsubmit="return confirm('Do you really want to store data ?');">
